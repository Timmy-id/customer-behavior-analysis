...
-- Q2. Which customers used a discount but still spent more than than the average purchase amount?
...
-- Q9. Are customers who are repeat buyers (more than 5 previous purchases) also likely to ssubscribe?
select subscription_status,
